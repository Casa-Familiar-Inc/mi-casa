            ...
            <div className="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Manage your organization's internal structure and department leaders.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Table>
                            ...
                            <TableBody>
                                {isLoading ? (
                                    ...
                                    <TableRow>
                                        <TableCell colSpan={4} className="text-center py-8 text-muted-foreground">No departments found. Add one to get started.</TableCell>
                                    </TableRow>
                                ) : (
